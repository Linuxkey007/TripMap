...
public class AlbumHelper {
	...
	private void getAlbumColumnData(Cursor cur) {
		if (cur.moveToFirst()) {
			...
			Log.i("我需要的值是", "_idColumn" + _idColumn + "albumColumn"
					+ albumColumn + "albumArtColumn" + albumArtColumn
					+ "albumKeyColumn" + albumKeyColumn + "artistColumn"
					+ artistColumn + "numOfSongsColumn" + numOfSongsColumn);
			do {
				_id = cur.getInt(_idColumn);
